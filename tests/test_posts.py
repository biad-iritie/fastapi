...
@pytest.mark.parametrize("title,content", [
    ("awesome new title with defaut published", "awesome content"),
    ("favorite Pizza", "I love pepperoni with defaut published"),
    ("tallest skyscrapers with defaut published", "wahoo"),
])
...
def test_delete_post_non_exist(authorized_client, test_user, test_posts):
    res = authorized_client.delete("/posts/30000000")
